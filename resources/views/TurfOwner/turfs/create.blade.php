                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="">
                            ...
                            <div>
                                ...
                                <input type="text" id="turf_name" name="turf_name"
                                    ...
                                    placeholder="ex: Akram Internation" value="{{ old('turf_name') }}">
                        ...
                        <div class="">
                            ...
                            <div>
                                ...
                                <select id="turf_type" name="turf_type"
                                    ...
                                    <option @if (old('turf_type') == 'Football') selected @endif value="Football">
                                        Football
                                    </option>
                                    <option @if (old('turf_type') == 'Cricket') selected @endif value="Cricket">
                                        Cricket
                                    </option>
                                    <option @if (old('turf_type') == 'Golf') selected @endif value="Golf">Golf
                                    </option>
                                    <option @if (old('turf_type') == 'Hokey') selected @endif value="Hokey">Hokey
                                    </option>
                                    <option @if (old('turf_type') == 'Batminton') selected @endif value="Batminton">
                                        Batminton</option>

                                    Batminton</option>
                                    <option @if (old('turf_type') == 'Tennis') selected @endif value="Tennis">Tennis
                                    </option>
                                    <option @if (old('turf_type') == 'Volleyball') selected @endif value="Volleyball">
                                        Volleyball</option>
                                </select>
                        ...
                        <div class="">
                            ...
                            <div>
                                ...
                                <select id="size" name="size"
                                    ...
                                    <option @if (old('size') == '9v9: 45m x 60m') selected @endif value="9v9: 45m x 60m">9
                                        v 9: 45m x 60m</option>
                                    <option @if (old('size') == '7v7: 30m x 50m') selected @endif value="7v7: 30m x 50m">
                                        7 v 7: 30m x 50m</option>
                                    <option @if (old('size') == '6v6: 25m x 40m') selected @endif value="6v6: 25m x 40m">
                                        6 v 6: 25m x 40m</option>
                                    <option @if (old('size') == '5v5: 20m x 30m') selected @endif value="5v5: 20m x 30m">
                                        5 v 5: 20m x 30m</option>
                                    <option @if (old('size') == '4v4: 12m x 20m') selected @endif value="4v4: 12m x 20m">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="url" id="map_iframe"
                                ...
                                name="map_iframe" value="{{ old('map_iframe') }}">
                        ...
                        <div class="col-span-2">
                            ...
                            <div>
                                ...
                                <textarea id="location" rows="6"
                                    ...
                                    placeholder="Write your thoughts here..." style="resize: none;" name="location">{{ old('location') }}</textarea>
                        ...
                        <div class="col-span-2">
                            ...
                            <div>
                                ...
                                <textarea id="description" rows="6" name="description"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary focus:border-primary dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                                    placeholder="Write your thoughts here..." style="resize: none;">{{ old('description') }}</textarea>
                ...
                <div class="tab-pane fade " id="three" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <div class="ring-1 ring-gray-100 p-1  grid lg:grid-cols-2 gap-x-4 mb-3">
                        ...
                        <div>
                            ...
                            <x-input-label for="price_for_90_minutes_at_day" :value="__('Price For 90 Minutes (Day)')" />
                    ...
                    <div class="ring-1 ring-gray-100 p-1  grid lg:grid-cols-2 gap-x-4 mb-3">
                        ...
                        <div>
                            <x-input-label for="price_for_120_minutes_at_day" :value="__('Price For 120 Minutes (Day)')" />
                            <input type="number" id="price_for_90_minutes_at_day"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                    ...
                    <div class="grid lg:grid-cols-2 gap-4 mb-2">
                        <div>
                            ...
                            <select id="brank_name" name="bank_name"
                                ...
                                <option @if (old('bank_name') == 'Bikash') selected @endif value="Bkash">Bkash
                                </option>
                                <option @if (old('bank_name') == 'Nogod') selected @endif value="Nogod">Nogod
                                </option>
                                <option @if (old('bank_name') == 'Rocket') selected @endif value="Rocket">Rocket
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <select id="brank_name" name="account_type"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 mt-1">
                                <option selected value="">Choose a Bank</option>
                                <option @if (old('account_type') == 'Personal') selected @endif value="Personal">Personal
                                </option>
                                <option @if (old('account_type') == 'Agent') selected @endif value="Agent">Agent
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" id="account_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                                placeholder="01245789654" name="account_number" value="{{ old('account_number') }}">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2">
                        <div>
                            ...
                            <input type="number" id="phone"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary dark:focus:border-primary"
                                placeholder="ex: 01245789564" name="phone">
