<x-dashboard-layout>
    ...
    <div class="w-full mt-4 mb-8 text-right">
        <a href="{{ route('turf-owner.staffs.create') }}"
    ...
    <div class="flex flex-col rounded-lg overflow-hidden">
        <div class=" bg-gray-100">
            <div class="inline-block min-w-full align-middle">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4  space-x-2 whitespace-nowrap">
                                        <div class="flex gap-4">
                                            <a href="{{ route('turf-owner.staffs.edit', ['staff' => $item->id]) }}">
                                                <button type="button"
                                            ...
                                            <form
                                                action="{{ route('turf-owner.staffs.destroy', ['staff' => $item->id]) }}"
                                                method="post">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit"
                ...
                <div class="w-full p-4 bg-white"> {{ $staffs->links() }}</div>
            </div>
        </div>
    </div>
