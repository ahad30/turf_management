    ...
    <x-card>
        <div class="flex flex-col rounded-lg overflow-hidden">
            <div class=" ">
                ...
                <form
                    action="{{ route('staff.updateBookingDetails', ['id' => $booking->id, 'payment_id' => $transaction->id]) }}"
                    method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                        <div class="w-full">
                            ...
                            <input type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $transaction->payment_with }}" readonly>
                        </div>
                        <div class="w-full">
                            <label for="price"
                        ...
                        <div class="w-full">
                            <label for="price"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Paid
                                Amount</label>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="mb-2">
                                    @if ($transaction->status == '2')
                                        <button class="rounded-lg bg-primary text-white p-3 h-10"><ion-icon
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                            <div class="mb-2">
                                ...
                                <select id="status" name="status"
                                    ...
                                    <option value="0" @if ($booking->status == '0') selected @endif>On
                                        Hold
                                    </option>
                                    <option value="1" @if ($booking->status == '1') selected @endif>Paid
                                    </option>
                                    <option value="2" @if ($booking->status == '2') selected @endif>
                                        Completed
                                    </option>
                                    <option value="3" @if ($booking->status == '3') selected @endif>
                                        Rejected
                                    </option>
                                </select>
                                @error('status')
                            ...
                            <div class="mb-2">
                                ...
                                <select id="status"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option value="0" @if ($booking->playing_status == '0') selected @endif>Play
                                        with
                                        friends
                                    </option>
                                    <option value="1" @if ($booking->playing_status == '1') selected @endif>Play
                                        with
                                        Others
                                    </option>
                                </select>
