                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            @foreach ($bookings as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    @php
                                        $payment = \App\Models\PaymentForTurfBooking::where('book_uid', $item->book_uid)->first();
                                    @endphp
                                    <td class="p-4 text-base font-normal text-gray-500   dark:text-gray-400 max-w-md">
                                        {{ $payment->amount }}
                                    </td>
                                    ...
                                    <td class="p-4 text-base font-normal text-gray-500   dark:text-gray-400 max-w-md">
                                        @if ($item->status == '0')
                                            <p class="text-yellow-500">On Hold</p>
                                        @elseif ($item->status == '1')
                                            <p class="text-blue-500">Paid</p>
                                    ...
                                    <td class="p-4  space-x-2 whitespace-nowrap">
                                        <div class="flex gap-4">
                                            <a
                                                href="{{ route('staff.editBookingDetail', ['id' => $item->id, 'payment_id' => $payment->id]) }}">
                                                <button type="button"
